...
import { AccountBookOutlined, FileTextOutlined, HomeOutlined, LogoutOutlined, PictureOutlined, SettingOutlined, UserOutlined } from "@ant-design/icons";
...
const adminMenus = [
    ...
    { key: "/admin/credit-logs", icon: <AccountBookOutlined />, label: "算力点日志" },
          ...
          : pathname.startsWith("/admin/credit-logs")
            ...
            : pathname.startsWith("/admin/prompts")
              ...
              : pathname.startsWith("/admin/users")
                ? "/admin/users"
                : "";
    const pageTitle = pathname.startsWith("/admin/settings") ? "系统设置" : pathname.startsWith("/admin/assets") ? "素材库管理" : pathname.startsWith("/admin/credit-logs") ? "算力点日志" : pathname.startsWith("/admin/users") ? "用户管理" : "提示词管理";
